...
export const sceneManifest: NarrativeScene[] = [
  {
    id: 'hero',
    asset: '/spike-assets/narrative/desktop/frame-001.webp',
  ...
  {
    id: 'trust',
    asset: '/spike-assets/narrative/desktop/frame-012.webp',
  ...
  {
    id: 'fleet',
    asset: '/spike-assets/narrative/desktop/frame-030.webp',
  ...
  {
    id: 'reveal',
    asset: '/spike-assets/narrative/desktop/frame-048.webp',
